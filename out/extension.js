...
function activate(context) {
    const provider = new keywordProvider_1.KeywordProvider();
    vscode.window.registerTreeDataProvider('robotKeywords', provider);
    context.subscriptions.push(vscode.commands.registerCommand('robotKeywords.refresh', () => {
        console.log("🔄 Refreshing keywords...");
        provider.refresh();
    }), vscode.commands.registerCommand('robotKeywords.openKeyword', (filePath, line) => {
        console.log(`📂 Opening keyword in file: ${filePath}, at line: ${line}`);
        provider.openKeyword(filePath, line);
    }), vscode.commands.registerCommand('robotKeywords.promptSearch', () => __awaiter(this, void 0, void 0, function* () {
